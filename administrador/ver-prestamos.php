    ...
    ?>
                <tr>
                    <td>
                        ...
                        <span class="sub-info">Carnet: <?php echo htmlspecialchars($prestamo['codigo_de_carnet']); ?></span>
                    </td>
                    <td>
                    ...
                    <td>
                        ...
                        <a href="eliminar_prestamo.php?id=<?php echo $prestamo['id_prestamo']; ?>" 
                           ...
                           onclick="return confirm('¿Estás seguro de que quieres eliminar este préstamo?');">
                           Eliminar
                        </a>
                    </td>
                </tr>
