            ...
            <tr data-clase="<?php echo htmlspecialchars($alumno['clase']); ?>" 
                ...
                <td>
                    <div style="display: flex; gap: 8px; flex-wrap: wrap;">
                        ...
                        <a href="eliminar_alumno.php?id=<?php echo $alumno['id_alumnado']; ?>" style="color: white; padding: 6px 12px; background-color: #f44336; border-radius: 4px; font-weight: bold; text-decoration: none; font-size: 0.85rem;" onclick="return confirm('¿Borrar a <?php echo $alumno['nombre']; ?>?')">Borrar</a>
                    </div>
                </td>
            </tr>
    <?php
